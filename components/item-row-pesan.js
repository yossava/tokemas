...
function ItemRowPesan(props) {
    ...
    return (
        <tr className='text-xs'>
            ...
            <td className="py-4 px-2 whitespace-no-wrap border-b border-gray-200">
                <input onChange={(e) => handleChange(e)} type="number" name='ongkos' className='rounded p-2 w-16 h-10 mr-2' placeholder='Ongkos' />
            </td>
