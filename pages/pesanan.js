...
import ItemRowPesan from '../components/item-row-pesan';
import NotaRowPesan from '../components/item-row-nota-pesan';
...
function Penjualan() {
    ...
    function rows() {
        ...
        for (let index = 0; index < count; index++) {
            arr.push(<ItemRowPesan key={index} number={index + 1} onChangeValue={handleChangeValue} goldNameOption={goldNameOption} goldTypeOption={goldTypeOption} transactionTypeOption={transactionTypeOption} priceOption={priceOption} />);
        }
    ...
    function notaRow() {
        ...
        for (const key in total) {
            if (Object.hasOwnProperty.call(total, key)) {
                const el = total[key];
                arr.push(<NotaRowPesan key={key} data={total[key]} />)
            }
        }
                    ...
                    <table className='w-full bg-white'>
                        <thead>
                            <tr>
                                ...
                                <th className="py-3 px-2 border-b border-gray-200 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Ongkos</th>
            ...
            <div className='bg-white border w-full mt-1 p-5 shadow-lg'>
                <div className='flex justify-between text-center mb-3'>
                    <div className='w-4/12 text-slate-600'>
                        ...
                        <div className='text-3xl font-bold text-sky-400'>AGUNG JAYA</div>
                        <p className='text-xs bg-sky-400 text-white uppercase font-bold'>jual beli & pemesanan</p>
                    ...
                    <div className='text-left text-xs'>
                        <p>No: <span className='font-bold text-sky-400'>{nomorNota}</span></p>
                ...
                <div className='w-full border-t flex text-left text-xs font-bold py-2 border-b bg-sky-400 text-white'>
                    ...
                    <div className='w-2/12'>Ongkos</div>
