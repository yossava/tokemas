            ...
            <div className='bg-white border w-full mt-1 p-5 shadow-lg'>
                <div className='flex justify-between text-center mb-3'>
                    <div className='w-4/12 text-slate-600'>
                        ...
                        <div className='text-3xl font-bold text-red-400'>AGUNG JAYA</div>
                        <p className='text-xs bg-red-400 text-white uppercase font-bold'>jual beli & pemesanan</p>
                    ...
                    <div className='text-left text-xs'>
                        <p>No: <span className='font-bold text-red-400'>{nomorNota}</span></p>
                ...
                <div className='w-full border-t flex text-left text-xs font-bold py-2 border-b bg-red-400 text-white'>
